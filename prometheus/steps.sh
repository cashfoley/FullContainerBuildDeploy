...
$ docker build -t cashfoley/webappmonitoring:prometheus .
$ docker run -d -p 5555:80/tcp cashfoley/webappmonitoring:prometheus
$ docker push cashfoley/webappmonitoring:prometheus
